...
export default function StudentDashboard() {
  ...
  const statsCards = [
    { label: 'Attendance Rate', value: '--', color: 'bg-blue-500' },
    { label: 'Total Sessions', value: '0', color: 'bg-green-500' },
    { label: 'Present', value: '0', color: 'bg-emerald-500' },
    { label: 'Pending Reviews', value: '0', color: 'bg-yellow-500' },
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <span className="ml-4 text-sm text-gray-500 dark:text-gray-400">Student Portal</span>
            </div>
