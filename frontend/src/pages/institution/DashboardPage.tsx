...
export default function InstitutionDashboard() {
  ...
  const statsCards = [
    ...
    { label: 'Attendance Rate', value: '--', color: 'bg-emerald-500' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <span className="ml-4 text-sm text-gray-500 dark:text-gray-400">Institution Admin</span>
            </div>
            <div className="flex items-center space-x-4">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Institution Admin</p>
                </div>
              </div>
